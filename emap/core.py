...
class Wire(egglog.Expr):
    ...
    @classmethod
    def from_dff(cls, dff_d: Wire) -> Wire: ...
...
class WireVec(egglog.Expr):
    ...
    @classmethod
    def zero_extended(cls, out_width: egglog.i64Like, a: WireVec) -> WireVec: ...

    @classmethod
    def sign_extended(cls, out_width: egglog.i64Like, a: WireVec) -> WireVec: ...
